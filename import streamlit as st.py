...
def recommend(music, similarity, selected_music_name):
    try:
        ...
        return None, None  # Handle missing music or similarity issues gracefully

music_dict = pickle.load(open(r'C:\Users\gayathri\Downloads\music reccccc\ex (2).csv"pkl', 'rb'))
